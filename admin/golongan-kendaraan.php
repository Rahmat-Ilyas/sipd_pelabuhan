...
$result = mysqli_query($conn, "SELECT * FROM tb_golongan");
?>
			...
			<div class="modal-body">
				<form class="form-horizontal" method="POST" action="controller.php">
					<div class="item form-group">
						<label class="col-form-label col-md-3 col-sm-3 label-align">Nama Golongan</label>
						<div class="col-md-7">
							<input type="text" name="golongan" required="required" class="form-control" placeholder="Nama Golongan" autocomplete="off">
						</div>
					</div>
					<div class="item form-group">
